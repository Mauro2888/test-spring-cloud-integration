...
public class MappingFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jtest_file2Label0 = new JLabel();
	JTextField jtest_file2TextField0 = new JTextField();
	...
	private void jbInit() throws Exception {
		jInfoLabel1.setText("THIS APPLICATION WAS GENERATED BY MapForce 2018r2");
	...
	protected void fillScrollPane() {
		...
		jtest_file2Label0.setText("Source instance of test_file.xsd:");
		jtest_file2Label0.setBounds(new Rectangle(15, 10, 438, 23));
		jPanelStructures.add(jtest_file2Label0, null);
		jtest_file2TextField0.setText("test_file.xml");
		jtest_file2TextField0.setBounds(new Rectangle(15, 35, 438, 23));
		jtest_file2TextField0.setEditable(false);
		jPanelStructures.add(jtest_file2TextField0, null);

		jOutput2Label1.setText("Instance of Output file:");
		jOutput2Label1.setBounds(new Rectangle(15, 60, 438, 23));
		jPanelStructures.add(jOutput2Label1, null);
		jOutput2TextField1.setText("Output.csv");
		jOutput2TextField1.setBounds(new Rectangle(15, 85, 438, 23));
		jOutput2TextField1.setEditable(false);
		jPanelStructures.add(jOutput2TextField1, null);
    ...
    void jStartButton_actionPerformed(ActionEvent e) {
		if (e.getSource().equals(jStartButton)) {
			...
			{
				com.altova.io.Input test_file2Source = com.altova.io.StreamInput.createInput("test_file.xml");
				com.altova.io.Output Output2Target = new com.altova.io.FileOutput("Output.csv");
